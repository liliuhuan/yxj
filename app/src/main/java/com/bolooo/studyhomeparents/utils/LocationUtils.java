...
public class LocationUtils {
    ...
    public static void register(final OnLocationChangeListener mListener){
        initLocation();
        myListener = new MyLocationListener(mListener);
    ...
    public static class MyLocationListener implements BDLocationListener {
        ...
        public MyLocationListener(OnLocationChangeListener mListener) {
