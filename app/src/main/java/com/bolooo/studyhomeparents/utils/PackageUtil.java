...
public class PackageUtil {
	...
	public static String getAppPackageName(){
		String pName = StudyApplication.getInstance().getContext().getPackageName();
		return pName;
	}

	/** 根据packageName获取packageInfo */
	public static PackageInfo getPackageInfo(String packageName) {
		Context context = StudyApplication.getInstance().getContext();
		if (null == context) {
			return null;
		}
	...
	public static String getChannelName(String name){
		...
		String value = null;
		try {
			appInfo = StudyApplication.getInstance().getContext().getPackageManager().getApplicationInfo(StudyApplication.getInstance().getContext().getPackageName(),PackageManager.GET_META_DATA);
