...
public class LookCourseEnity implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeList(this.Areas);
        dest.writeList(this.CourseShowResponses);
    }

    public LookCourseEnity() {
    }

    protected LookCourseEnity(Parcel in) {
        this.Count = in.readInt();
        this.Areas = new ArrayList<AreasEntity>();
        in.readList(this.Areas, AreasEntity.class.getClassLoader());
    ...
    public static final Parcelable.Creator<LookCourseEnity> CREATOR = new Parcelable.Creator<LookCourseEnity>() {
        @Override
        public LookCourseEnity createFromParcel(Parcel source) {
            return new LookCourseEnity(source);
        }

        @Override
        public LookCourseEnity[] newArray(int size) {
            return new LookCourseEnity[size];
        }
    };
}
