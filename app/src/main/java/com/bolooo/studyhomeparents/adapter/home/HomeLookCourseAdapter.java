...
public class HomeLookCourseAdapter extends BaseRecycleViewAdapter<LookCourseEnity.CourseShowResponsesEntity> {


    public HomeLookCourseAdapter(Context context) {
        super(context);
    }
    ...
    @Override
    public BaseRecycleViewHolder<LookCourseEnity.CourseShowResponsesEntity> getNewHolder(View view) {
        return new MyHomeLookViewHolder(view);
    }

    public class MyHomeLookViewHolder extends BaseRecycleViewHolder<LookCourseEnity.CourseShowResponsesEntity> {
        ...
        @Override
        public void loadData(LookCourseEnity.CourseShowResponsesEntity data, int position) {
            if (data == null) return;
