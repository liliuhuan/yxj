...
import com.bolooo.studyhomeparents.views.recyclerview.indicators.AVLoadingIndicatorView;
    ...
    private View initIndicatorView(int style) {
        if(style == ProgressStyle.SysProgress) {
            ...
            AVLoadingIndicatorView
                progressView = (AVLoadingIndicatorView) LayoutInflater.from(getContext()).inflate(R.layout.layout_indicator_view, null);
