...
public class BadgeView extends TextView {
	...
	public BadgeView(Context context, View target) {
		this(context, null, android.R.attr.textViewStyle, target, 0, 0);
	}
	 ...
	 *            ԭ��뾶
	 */
	public BadgeView(Context context, View target, int radius) {
		this(context, null, android.R.attr.textViewStyle, target, 0, radius);
	...
	public BadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex, int radius) {
		super(context, attrs, defStyle);
		init(context, target, tabIndex, radius);
	}

	private void init(Context context, View target, int tabIndex, int radius) {
