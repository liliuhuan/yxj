...
//		progressBar.setInterpolator(_Interpolator);
		...
		int margin = DensityUtil.dip2px(context, 18);
		params.setMargins(margin, DensityUtil.dip2px(context, 5), margin, DensityUtil.dip2px(context, 5));
		 mTextView = new TextView(context);
		LinearLayout.LayoutParams tvParams = new LinearLayout.LayoutParams
				(LinearLayout.LayoutParams.MATCH_PARENT,LinearLayout.LayoutParams.WRAP_CONTENT);
		tvParams.bottomMargin = DensityUtil.dip2px(context, 5);
